...
exports.index = function(request, response) {
  ...
  db.query(sql, function(err, result_notice) {
    ...
    db.query(sql, function(err, result_gallery) {
      ...
      db.query(sql, function(err, result_product) {
        response.render('index', {session : request.session, data_notice : result_notice, data_gallery : result_gallery, data_product : result_product});
      });
    });
  });
